...
var instrucciones = ['Solo se podra mover la pieza vacia.','Se mostrara un mensaje si logra colocar las piezas en la posicion correcta.','Debajo se muestra una imagen de referencia.'];
...
function mostrarInstrucciones(instrucciones) {
    //COMPLETAR
    for (var i = 0; instrucciones.length > i; i++) {
...
function chequearSiGano() {
    //COMPLETAR
    for (var i = 0; grilla.length > i; i++) {
      for (var j = 0; grilla[i].length > j; j++) {
        console.log(grilla[i][j] + ' - '  +  grillaGanadora[i][j]);
        chequeaSiSonIguales(grilla[i][j], grillaGanadora[i][j]);
      }
    }     
...
function chequeaSiSonIguales(num1, num2){
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    ...
    var cordenada1 = grilla[filaPos1][columnaPos1];
    var cordenada2 = grilla[filaPos2][columnaPos2];
    grilla[filaPos1][columnaPos1] = cordenada2;
    grilla[filaPos2][columnaPos2] = cordenada1;
}
