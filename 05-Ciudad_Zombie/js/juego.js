...
var Juego = {
    ...
    altoCanvas: 577,
    jugador: Jugador,
    zombieCaminante: ZombieCaminante,
    ...
    obstaculosCarretera: [
       ...
       // new Obstaculo('imagenes/valla_horizontal.png', 145, 360, 30, 30, 1),
        new Obstaculo('imagenes/bache.png', 70, 390, 30, 30, 1),
    ...
    enemigos: [
        ...
        new ZombieCaminante('imagenes/zombie1.png', 200, 80, 10, 10, 6, [-90, 950, 80, 80]),
        new ZombieCaminante('imagenes/zombie2.png', 500, 390, 10, 10, 2, [-90, 950, 390, 390]),
        new ZombieCaminante('imagenes/zombie3.png', 250, 345, 10, 10, 3, [-90, 950, 345, 345]),
        new ZombieCaminante('imagenes/zombie4.png', 320, 426, 10, 10, 2, [-90, 950, 426, 426]),

        new ZombieCaminante('imagenes/zombie1.png', 370, 300, 10, 10, 5, [-90, 950, 300, 300]),
        new ZombieCaminante('imagenes/zombie1.png', 450, 450, 10, 10, 4, [-90, 950, 450, 450]),
        new ZombieCaminante('imagenes/zombie1.png', 500, 500, 10, 10, 6, [-90, 950, 500, 500]),
        new ZombieCaminante('imagenes/zombie1.png', 550, 520, 10, 10, 3, [-90, 950, 520, 520]),

        new ZombieConductor('imagenes/tren_horizontal.png', 950, 325, 90, 30, 10, [-90, 950, 325, 325], 'H'),

        new ZombieConductor('imagenes/tren_vertical.png', 643, -80, 30, 90, 10, [643, 643, -80, 570], 'V'),
        new ZombieConductor('imagenes/tren_vertical.png', 675, 570, 30, 90, 10, [675, 675, -80, 570], 'V'),
    ...
    if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
      //console.log(this.jugador.x);
        ...
        switch (tecla) {
            ...
            case 'der':
                Dibujante.dibujarEntidad(jugador.girarDerecha());
                jugador.moverDerecha();
                break;

            case 'arriba':
                Dibujante.dibujarEntidad(jugador.girarArriba());
                jugador.moverArriba();
                break;

            case 'abajo':
                Dibujante.dibujarEntidad(jugador.girarAbajo());
                jugador.moverAbajo();
                break;

            case 'izq':
                Dibujante.dibujarEntidad(jugador.girarIzquierda());
...
Juego.chequearColisiones = function(x, y) {
    ...
    this.obstaculos().forEach(function(obstaculo) {
        if (this.intersecan(obstaculo, this.jugador, x, y)) {
            ...
            console.log('me toco obstaculo');
            chocar(obstaculo,this.jugador);
            puedeMoverse = false
        }
    }, this)
    return puedeMoverse
